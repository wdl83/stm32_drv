...
#define TLOG_XPRINT2x8(str, v1, v2)
#define TLOG_XPRINT4x8(str, v1, v2, v3, v4)
...
#define TLOG_XPRINT32(str, value) \
    do \
    { \
        char buf__[15 /* str */ + 8 /* value */ + 1 /* \n */]; \
        char *curr__ = scopy(buf__, (str), 15); \
        curr__ = xprint32(curr__, (uint32_t)(value)); \
        *curr__++ = '\n'; \
        tlog_append(buf__, curr__ - buf__); \
    } while(0);

#define TLOG_XPRINT2x8(str, v1, v2) \
    TLOG_XPRINT16((str), ((uint16_t)(v1) << 8) | (v2))
